...
const source = fs.readFileSync(path.join(__dirname, '../test/assets/react.production.min.js'), 'utf-8');
...
.on('complete', function() {
  console.log('Check react.production.min.js minified: the fastest is ' + this.filter('fastest').map('name'));
})
